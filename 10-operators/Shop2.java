...
public class Shop2 {
    ...
    public static void main(String[] args) {
        ...
        if (total>= 1000) {
            ...
            finales = finales - promotion;
              ...
              System.out.println("""
                ...
                ------------------------------------
                TOTAL                      %.2f
                """.formatted(numPacketsTrousers, numPacketsTshirts, numPacketsTotal, total, finalDiscount, totalShipping,promotion, finales));
        ...
        System.out.println("""
                ...
                ------------------------------------
                TOTAL                      %.2f
                """.formatted(numPacketsTrousers, numPacketsTshirts, numPacketsTotal, total, finalDiscount, totalShipping,amountToPromotion, finales));
    }
}
}
